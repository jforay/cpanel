...
$form = array(
	...
	'email' => array(
		'from' => 'dsflyguy@yahoo.com',
		'to' => 'dsflyguy@yahoo.com'
	),
	'fields' => array(
		'custom_U198' => array(
			'order' => 1,
		...
		'custom_U209' => array(
			...
			'required' => true,
			'errors' => array(
				'required' => 'Field \'Best Phone\' is required.'
			)
		),
		'custom_U1182' => array(
			'order' => 5,
			'type' => 'string',
			'label' => 'Descibe Your Boating Experience',
			'required' => true,
			'errors' => array(
				'required' => 'Field \'Descibe Your Boating Experience\' is required.'
			)
		)
	)
);
